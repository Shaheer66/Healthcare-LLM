...
* Engineered brand new LLM Corpus Dataset of size 6800 samples from scratch. Started with scraping based on [healthline.com](https://www.healthline.com/directory/topics), .[MayoClinic](https://www.mayoclinic.org/diseases-conditions)
...
## Model Deployment
A `Gradio App` was coded to deploy the LLM model in HuggingFace. This live huggingfaces API is later integrated in the Back-End. The Gradio implementation can be found in `deployment_hf` folder




## Live Website Deployment
Deployed a Flask App, built to provide user interface to users. The website will be live at [EarlyMed](https://earlymed.netlify.app/) with some other features as well
...
I do have plan to incorporate a more powerful model for a more seamless interactive experience. In my free time, I do hope to execute it. 
